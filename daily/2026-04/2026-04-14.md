# EMS Agent Workshop 日报 — 2026-04-14（周一）

**活跃人数**：~15 人 | **消息数**：~50 条 | **时间跨度**：10:51 - 15:07（北京时间）

📷 图片提取：8 张全部下载成功（API 方式）
...
![Juanjuan Liu - PM agent PPT](images/2026-04-14-003.png)
...
![He Zhang - queue项目截图](images/2026-04-14-008.png)

- **Jingxia Xing**："我正在切割我的 512G，启动多个 docker 来一起搞，48G 的 MacBook 风扇烧了两天了，我从来没听过"
- **Dale Xiao**："这就是金钱的声音吗？"

![Zhiyuan Zheng - A2A K8s工具截图](images/2026-04-14-007.png)

- **Zhiyuan Zheng**："有同事用过这个吗？"
- **He Zhang**："没有，但感觉看起来就是我想要的 a2a k8s。这个真的可以搞"

![Jingxia Xing - 工具截图](images/2026-04-14-006.png)
...
🧠 **解读**：当 agent 从"一个人用一个"变成"一个人管六个"，单机架构扛不住了。A2A + K8s 的组合可能是未来 agent 基础设施的主流形态。He Zhang 的 Discord Skills 体系也值得关注：把所有能力抽象为可复用的 skill，通过 epoch 标识做自我迭代。

#multi-agent #infrastructure #a2a-k8s #distributed-system #discord-skills
...
![Bojun Chai - claude-starter 截图1](images/2026-04-14-004.png)

![Bojun Chai - claude-starter 截图2](images/2026-04-14-005.png)

- 安装：`npm install -g claude-starter`
- Codex 版本：`npm install -g codex-starter`
- 已有 **1.2k+ npm 下载** + "全球好评（共 1 条）"，号称"体验 100x"

🧠 **解读**：小工具大价值。`/resume` 是 Claude Code 用户的共同痛点，Bojun 用一个轻量 CLI 就解决了。
...
![Jie Tang - face fortune截图](images/2026-04-14-002.png)

**OPC 的自复制能力**：He Zhang 和 Xiaolin 都已经蒸馏出自己的 OPC 版本。

🧠 **解读**：OPC/梦工厂从工具变产品，从 token 消耗变价值产出。OPC 能"自复制"是一个里程碑。
...
![He Zhang - backup大号截图](images/2026-04-14-001.png)

He Zhang 为防止大号也被封，搞了个 backup 方案。

🧠 **解读**：Skills 本质是把经验和最佳实践固化为可复用的能力模块。10+ skills 是一个好目标。
...
🏷 **全局标签**：#harness #openclaw #agent-team #multi-agent #a2a-k8s #claude-starter #opc #dreamworks #skills #github-backup
